    ...
    require('neo-tree').setup {
      ...
      default_component_configs = {
        ...
        indent = {
          ...
          indent_marker = '│',
          last_indent_marker = '└',
          highlight = 'NeoTreeIndentMarker', -- expander config, needed for nesting files
      ...
      window = {
        ...
        width = 60, -- Increased width for floating window
        height = 25, -- Height for floating window
        ...
        popup = {
          ...
          border = 'rounded', -- border style: 'rounded', 'single', 'double', 'shadow', etc.
        },
        mapping_options = {
          noremap = true,
          nowait = true,
